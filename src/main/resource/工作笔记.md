...
quartz:
 ...
 Linux相关:
	重启游戏: /home/root/wow-server/scripts/service.sh restart
	日志目录: /data/log/dldl
	jar/配置: /home/root/wow-server
	进程启动信息:
...
内网数据库 mysql -h rds400v8jm57k41x3711.mysql.rds.aliyuncs.com -uqidea -pZqn6zTAQ
...
常挑战(fightEnd)和快速通关(quickPass),增加圣柱挑战次数成就时漏掉了,谨记!